 ...
 *
 */
public class SExprBench extends AbstractBenchmarked {
	...
	byte []byteArray ;
	{
		...
		try {
			...
			long size=  file.length(); if (size>Integer.MAX_VALUE) throw new IOException("input file too big");
	...
	public static void main(String[] args) {
		...
		Benchmark bm= new Benchmark(new SExprBench(), repeatAction, repeatBenchmark,5); 
		System.out.println();
		bm.benchmark();
		System.out.println(
